...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-white">Tambah Informasi</h1>
    <p class="mt-2 text-blue-100">Buat pengumuman baru untuk pengguna</p>
</div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div>
                        ...
                        <input type="text" name="judul" required
                               ...
                               placeholder="Contoh: Jadwal Libur Hari Raya Idul Fitri">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="8" required
                                  class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-slate-700 placeholder-slate-400"
                                  placeholder="Tuliskan detail lengkap informasi di sini..."></textarea>
                    </div>
                </div>
