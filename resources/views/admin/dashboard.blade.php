...
<div class="mb-6">
    ...
    <p class="mt-2 text-gray-600 dark:text-gray-400">Ringkasan sistem bimbel</p>
</div>
...
<div class="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-3">
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['total_kelas'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Mapel</p>
                <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['total_mapel'] }}</p>
            </div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['total_pengajar'] }}</p>
    </div>
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Siswa</p>
        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['total_siswa'] }}</p>
    </div>
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Wali</p>
        <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $stats['total_wali'] }}</p>
    </div>
</div>
@endsection
