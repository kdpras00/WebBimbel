...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.mapel.create') }}" class="px-4 py-2 bg-white text-blue-600 rounded-lg hover:bg-blue-50 font-medium transition-colors">
        Tambah Mapel
    </a>
</div>
                    ...
                    <tr class="bg-white border-b border-gray-200">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <form action="{{ route('admin.mapel.destroy', $m->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-600 hover:underline" onclick="confirmDelete(event, 'Yakin ingin menghapus mata pelajaran ini?')">Hapus</button>
                            </form>
                        </td>
                    </tr>
                @empty
