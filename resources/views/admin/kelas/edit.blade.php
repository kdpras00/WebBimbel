...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-black">Edit Kelas</h1>
</div>
    ...
    <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="deskripsi" rows="3"
                      class="bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 text-black">{{ old('deskripsi', $kelas->deskripsi) }}</textarea>
        </div>
