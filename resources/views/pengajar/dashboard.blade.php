...
<div class="grid grid-cols-1 gap-6 mb-6 lg:grid-cols-4">
    <div class="p-6 rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-black">{{ $stats['total_materi'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6 rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-black">{{ $stats['total_quiz'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6 rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-gray-600">Quiz Published</p>
                <p class="text-2xl font-bold text-black">{{ $stats['total_quiz_published'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-6 rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-black">{{ $stats['total_siswa_mengerjakan'] }}</p>
            </div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-black">Materi Terbaru</h2>
        </div>
        <div class="p-6">
            @forelse($recentMateri as $materi)
                <div class="mb-4 pb-4 border-b border-gray-200 last:border-0">
                    <h3 class="font-medium text-black mb-1">{{ $materi->judul }}</h3>
                    <p class="text-sm text-gray-600">{{ $materi->mapel->nama }}</p>
    ...
    <div class="rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-black">Quiz Terbaru</h2>
        </div>
        <div class="p-6">
            @forelse($recentQuiz as $quiz)
                <div class="mb-4 pb-4 border-b border-gray-200 last:border-0">
                    <div class="flex items-center justify-between mb-1">
                        <h3 class="font-medium text-black">{{ $quiz->judul }}</h3>
                    ...
                    <p class="text-sm text-gray-600">{{ $quiz->mapel->nama }}</p>
                    <p class="text-xs text-gray-500 mt-1">{{ $quiz->created_at->format('d M Y') }}</p>
                </div>
            @empty
