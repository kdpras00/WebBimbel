...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tambah Materi</h1>
</div>
...
<div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6">
    <form action="{{ route('pengajar.materi.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4" id="fileInput">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Maksimal 10MB</p>
        </div>
        ...
        <div class="mb-4" id="textInput">
            ...
            <textarea name="konten" rows="10"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">{{ old('konten') }}</textarea>
        </div>
