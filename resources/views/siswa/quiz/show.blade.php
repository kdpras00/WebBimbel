...
<div class="mb-6">
    <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
        ...
        <div class="flex items-center gap-3">
            @if($quiz->durasi)
                <div id="timerContainer" class="flex items-center gap-2 px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg border-2 border-indigo-300 dark:border-indigo-700 transition-colors">
            ...
            @endif
            <div id="warningBadge" class="flex items-center gap-2 px-4 py-2 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg border-2 border-yellow-300 dark:border-yellow-700 transition-colors">
