    ...
    <div class="p-6 rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-black">{{ $totalPoin }}</p>
            </div>
        </div>
    </div>
...
<div class="rounded-lg shadow border border-gray-200" style="background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%);">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-xl font-semibold text-black">Hasil Quiz Terakhir</h2>
    </div>
            ...
            <tbody>
                @forelse($recentResults as $result)
                    <tr class="bg-white border-b">
                        <td class="px-6 py-4 font-medium text-black">{{ $result->quiz->judul }}</td>
                        <td class="px-6 py-4 text-black">{{ $result->nilai }}</td>
